...
public:
	...
	~CStudent();
protected:
	TCHAR m_tzNAme[MAX_PATH];
	int m_iAge;
	TCHAR m_tzPhone[MAX_PATH];
public:
...
void CStudent::SetInfo(CString strName, int iAge, CString strPhone)
{
}

CString CStudent::GetName(void)
{
	return CString();
}

CString CStudent::GetAge(void)
{
	return CString();
}

CString CStudent::GetPhone(void)
{
	return CString();
}
